...
public class Extrusioner extends BlockContainer {
	...
	public Extrusioner(boolean isworking) {
		super(Material.iron);
		working = isworking;
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		...
		return new ExtrusionerTileEntity();
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_,
		...
		// TODO Auto-generated method stub
		player.openGui(SciRevolution.instance, 4, world, x, y, z);
		return true;
	}
	...
	public void registerBlockIcons(IIconRegister r) {
		...
		this.front = r.registerIcon(this.working ? "scirev:extrusioner_front_on" : "scirev:extrusioner_front_off");
	...
	public static void updateBlockState(boolean b, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		normalreplace = true;
		if (b) {
			worldObj.setBlock(xCoord, yCoord, zCoord, SciRevolution.lit_ex);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord, SciRevolution.ex);
		}
		normalreplace = false;
	...
	public void breakBlock(World world, int x, int y, int z, Block p_149749_5_,
		...
		// TODO Auto-generated method stub
		if (!normalreplace) {
			ExtrusionerTileEntity entity = (ExtrusionerTileEntity) world.getTileEntity(x, y, z);
	...
	public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
		// TODO Auto-generated method stub
		return Item.getItemFromBlock(SciRevolution.ex);
	}
