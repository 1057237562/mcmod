...
public class ExtrusionerContainer extends Container {

	private int lastPower = 0;
	private int lastMaxPower = 0;
	private int lastProgress = 0;

	private ExtrusionerTileEntity tile;

	public ExtrusionerContainer(InventoryPlayer par1InventoryPlayer, ExtrusionerTileEntity entity) {
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2) {
		...
		if (var4 != null && var4.getHasStack()) {
			...
			if (par2 >= 0 && par2 <= 2) {
				...
				if (ExtrusionerCraftingRecipe.isRecipeItem(var5.getItem())) {
