...
public class LathePowerSource extends BlockContainer {

	public LathePowerSource() {
		super(Material.iron);
	...
	public void onNeighborBlockChange(World world, int x, int y, int z,
	        Block block) {
		// TODO Auto-generated method stub
		updateMuiltBlock(world, x, y, z);
		super.onNeighborBlockChange(world, x, y, z, block);
	}

	public static void updateMuiltBlock(World world, int x, int y, int z) {
		// TODO Auto-generated method stub
		try {
			if ((LatheManipulatePanelEntity) world.getTileEntity(x + 1, y, z) != null) {
				LatheManipulatePanel.checkMuiltBlock(world, x + 1, y, z);
			}
		...
		try {
			if ((LatheManipulatePanelEntity) world.getTileEntity(x, y, z + 1) != null) {
				LatheManipulatePanel.checkMuiltBlock(world, x, y, z + 1);
			}
		} catch (ClassCastException e) {
			// TODO: handle exception
		}
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		// TODO Auto-generated method stub
		return new LathePowerSourceEntity();
	}
