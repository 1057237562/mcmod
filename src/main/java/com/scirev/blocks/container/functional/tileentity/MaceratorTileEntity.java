...
public class MaceratorTileEntity extends ElectricStorageEntity implements IInventory {
	...
	public void updateEntity() {
		...
		if (!worldObj.isRemote) {
			if (power > 0) {
				...
				Macerator.updateBlockState(progress > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
	}
