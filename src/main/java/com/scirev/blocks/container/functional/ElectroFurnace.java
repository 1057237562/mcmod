...
public class ElectroFurnace extends BlockContainer {
	...
	public ElectroFurnace(boolean lit) {
		super(Material.rock);
		light = lit;
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_,
		...
		player.openGui(SciRevolution.instance, 5, world, x, y, z);
		return true;
	}
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		// TODO Auto-generated method stub
		return new ElectroFurnaceEntity();
	}
	...
	public void registerBlockIcons(IIconRegister r) {
		...
		this.front = r.registerIcon(this.light ? "scirev:efurnace_front_on" : "scirev:efurnace_front_off");
	...
	public static void updateBlockState(boolean b, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		normalreplace = true;
		if (b) {
			worldObj.setBlock(xCoord, yCoord, zCoord, SciRevolution.lit_ef);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord, SciRevolution.ef);
		}
		normalreplace = false;
	...
	public void breakBlock(World world, int x, int y, int z, Block p_149749_5_, int p_149749_6_) {
		// TODO Auto-generated method stub
		if (!normalreplace) {
			ElectroFurnaceEntity entity = (ElectroFurnaceEntity) world.getTileEntity(x, y, z);
	...
	public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
		// TODO Auto-generated method stub
		return Item.getItemFromBlock(SciRevolution.ef);
	}
