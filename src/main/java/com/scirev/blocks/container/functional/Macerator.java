...
public class Macerator extends BlockContainer {
	...
	public Macerator(boolean isworking) {
		super(Material.iron);
		working = isworking;
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		...
		return new MaceratorTileEntity();
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_,
		...
		// TODO Auto-generated method stub
		player.openGui(SciRevolution.instance, 2, world, x, y, z);
		return true;
	}
	...
	public void registerBlockIcons(IIconRegister r) {
		...
		this.front = r.registerIcon(this.working ? "scirev:macerator_front_on" : "scirev:macerator_front_off");
	...
	public static void updateBlockState(boolean b, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		normalreplace = true;
		if (b) {
			worldObj.setBlock(xCoord, yCoord, zCoord, SciRevolution.lit_mac);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord, SciRevolution.mac);
		}
		normalreplace = false;
