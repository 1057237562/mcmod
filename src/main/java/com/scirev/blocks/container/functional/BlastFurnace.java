...
public class BlastFurnace extends BlockContainer {
	...
	public BlastFurnace(boolean lit) {
		super(Material.rock);
		working = lit;
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_,
		...
		player.openGui(SciRevolution.instance, 3, world, x, y, z);
		return true;
	}
	...
	public void registerBlockIcons(IIconRegister r) {
		this.blockIcon = r.registerIcon("furnace_side");
		this.front = r.registerIcon(this.working ? "scirev:blastfurnace_front_on" : "scirev:blastfurnace_front_off");
		this.top = r.registerIcon("furnace_top");
		this.bottom = r.registerIcon("furnace_top");
	}
	...
	public static void updateBlockState(boolean b, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		normalreplace = true;
		if (b) {
			worldObj.setBlock(xCoord, yCoord, zCoord, SciRevolution.lit_bf);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord, SciRevolution.bf);
		}
		normalreplace = false;
	...
	public void breakBlock(World world, int x, int y, int z, Block p_149749_5_, int p_149749_6_) {
		// TODO Auto-generated method stub
		if (!normalreplace) {
			BlastFurnaceEntity entity = (BlastFurnaceEntity) world.getTileEntity(x, y, z);
	...
	public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
		// TODO Auto-generated method stub
		return Item.getItemFromBlock(SciRevolution.bf);
	}
