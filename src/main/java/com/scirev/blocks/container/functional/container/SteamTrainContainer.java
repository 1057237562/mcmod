...
public class SteamTrainContainer extends Container {

	private int lastGeneratorBurnTime = 0;
	private int lastMaxBurnTime = 0;
	private int lastWaterStorage = 0;
	private SteamTrainEntity tile;

	public SteamTrainContainer(InventoryPlayer par1InventoryPlayer, SteamTrainEntity entity) {
	...
	public void addCraftingToCrafters(ICrafting par1iCrafting) {
		...
		par1iCrafting.sendProgressBarUpdate(this, 2, this.tile.waterstorage);
	}
	...
	public void detectAndSendChanges() {
		...
		while (var1.hasNext()) {
			...
			if (this.lastWaterStorage != this.tile.waterstorage) {
				var2.sendProgressBarUpdate(this, 2, this.tile.waterstorage);
			}
		}
		this.lastGeneratorBurnTime = this.tile.generatorBurnTime;
		this.lastMaxBurnTime = this.tile.maxBurnTime;
		this.lastWaterStorage = this.tile.waterstorage;
	}
