...
public class MaceratorGUI extends GuiContainer {

	MaceratorTileEntity tile;

	public MaceratorGUI(InventoryPlayer inventory, MaceratorTileEntity entity) {
		super(new MaceratorContainer(inventory, entity));
		tile = entity;
		doesGuiPauseGame();
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		this.fontRendererObj.drawString(StatCollector.translateToLocal("tile.Macerator.name"), 65, 6, 4210752);
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
		...
		this.mc.renderEngine.bindTexture(new ResourceLocation("scirev", "textures/gui/GUIMacerator.png"));
