...
public class SteamTrainGUI extends GuiContainer {

	SteamTrainEntity tile;

	public SteamTrainGUI(InventoryPlayer inventory, SteamTrainEntity entity) {
		super(new SteamTrainContainer(inventory, entity));
		tile = entity;
		doesGuiPauseGame();
