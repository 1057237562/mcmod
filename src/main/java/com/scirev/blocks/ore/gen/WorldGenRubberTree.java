...
public class WorldGenRubberTree extends WorldGenAbstractTree {
	...
	public WorldGenRubberTree(boolean p_i2027_1_, Block w, Block l)
    {
		this(p_i2027_1_, 5, 9, 0, 0, false, w, l);
    }

	public WorldGenRubberTree(boolean p_i2028_1_, int p_i2028_2_, int max, int p_i2028_3_, int p_i2028_4_,
	        boolean p_i2028_5_,
	        Block w, Block l)
    {
        super(p_i2028_1_);
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
		int l = p_76484_2_.nextInt(maxTreeHeight - minTreeHeight) + this.minTreeHeight;
		boolean flag = true;
		...
		if (p_76484_4_ >= 1 && p_76484_4_ + l + 1 <= 256) {
			...
			if (!flag) {
				...
				boolean isSoil = block2.canSustainPlant(p_76484_1_, p_76484_3_, p_76484_4_ - 1, p_76484_5_,
				        ForgeDirection.UP, (BlockSapling) SciRevolution.generalsapling);
							...
							for (int k2 = p_76484_5_ - l1; k2 <= p_76484_5_ + l1; ++k2) {
								...
								if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || p_76484_2_.nextInt(2) != 0 && i3 != 0) {
									...
									if (block1.isAir(p_76484_1_, i2, k1, k2)
										...
										this.setBlockAndNotifyAdequately(p_76484_1_, i2, k1, k2, leave,
										        this.metaLeaves);
									}
								}
							}
						...
						if (block.isAir(p_76484_1_, p_76484_3_, p_76484_4_ + k1, p_76484_5_)
							...
							if (this.vinesGrow && k1 > 0) {
								if (p_76484_2_.nextInt(3) > 0
								        && p_76484_1_.isAirBlock(p_76484_3_ - 1, p_76484_4_ + k1, p_76484_5_)) {
									this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_ - 1, p_76484_4_ + k1,
									        p_76484_5_, Blocks.vine, 8);
								}

								if (p_76484_2_.nextInt(3) > 0
								        && p_76484_1_.isAirBlock(p_76484_3_ + 1, p_76484_4_ + k1, p_76484_5_)) {
									this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + k1,
									        p_76484_5_, Blocks.vine, 2);
								}

								if (p_76484_2_.nextInt(3) > 0
								        && p_76484_1_.isAirBlock(p_76484_3_, p_76484_4_ + k1, p_76484_5_ - 1)) {
									this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + k1,
									        p_76484_5_ - 1, Blocks.vine, 1);
								}

								if (p_76484_2_.nextInt(3) > 0
								        && p_76484_1_.isAirBlock(p_76484_3_, p_76484_4_ + k1, p_76484_5_ + 1)) {
									this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + k1,
									        p_76484_5_ + 1, Blocks.vine, 4);
								}
							}
						}
					}
							...
							for (i2 = p_76484_3_ - l1; i2 <= p_76484_3_ + l1; ++i2) {
								for (j2 = p_76484_5_ - l1; j2 <= p_76484_5_ + l1; ++j2) {
									if (p_76484_1_.getBlock(i2, k1, j2).isLeaves(p_76484_1_, i2, k1, j2)) {
										if (p_76484_2_.nextInt(4) == 0 && p_76484_1_.getBlock(i2 - 1, k1, j2)
										        .isAir(p_76484_1_, i2 - 1, k1, j2)) {
										...
										if (p_76484_2_.nextInt(4) == 0 && p_76484_1_.getBlock(i2, k1, j2 - 1)
										        .isAir(p_76484_1_, i2, k1, j2 - 1)) {
							...
							for (k1 = 0; k1 < 2; ++k1) {
								for (i3 = 0; i3 < 4; ++i3) {
									if (p_76484_2_.nextInt(4 - k1) == 0) {
										...
										this.setBlockAndNotifyAdequately(p_76484_1_,
										        p_76484_3_ + Direction.offsetX[Direction.rotateOpposite[i3]],
										        p_76484_4_ + l - 5 + k1,
										        p_76484_5_ + Direction.offsetZ[Direction.rotateOpposite[i3]],
