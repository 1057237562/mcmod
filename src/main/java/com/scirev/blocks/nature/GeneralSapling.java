...
import com.scirev.blocks.ore.gen.WorldGenRubberTree;
...
public class GeneralSapling extends BlockSapling {
	private static final IIcon[] icons = new IIcon[GeneralLog.logs.length];

	public GeneralSapling() {
		float f = 0.4F;
	...
	public void func_149878_d(World p_149878_1_, int p_149878_2_, int p_149878_3_, int p_149878_4_,
		...
		Object object = new WorldGenRubberTree(true, SciRevolution.generallog, SciRevolution.generalleave);
		int i1 = 0;
		int j1 = 0;
		boolean flag = false;
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		for (int i = 0; i < icons.length; ++i) {
			icons[i] = p_149651_1_.registerIcon(this.getTextureName() + GeneralLog.logs[i]);
		}
	}
